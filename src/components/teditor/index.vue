...
const props = defineProps({
  ...
  plugins: {
    type: [String, Array],
    default:
      'importcss autoresize searchreplace autolink directionality nonbreaking  insertdatetime lists ',
  ...
  toolbar: {
    ...
    default:
      'accordion accordionremove | blocks fontfamily fontsize| bold italic underline strikethrough ltr rtl  | align numlist bullist | link image | table | lineheight outdent indent| forecolor backcolor removeformat | charmap emoticons | anchor codesample',
...
const init = reactive({
  ...
  language_url: `${prefix}tinymce/langs/zh_CN.js`, // 语言包的路径，具体路径看自己的项目
  language: 'zh_CN',
  skin_url: `${prefix}tinymce/skins/ui/oxide`, // skin路径，具体路径看自己的项目
  ...
  // 默认样式
  content_style:
    'body { font-family:宋体; font-size:16px }p {margin:3px; line-height:24px;}',
  image_advtab: true,
  ...
  content_css: `${prefix}tinymce/skins/content/default/content.css`, // 以css文件方式自定义可编辑区域的css样式，css文件需自己创建并引入
