...
export function memberList(data: Record<string, any>) {
  return $http.post('/web/member/list', data);
}

//  查找手机号是否注册
export function memberPhone(params: Record<string, any>) {
  return $http.get('/web/member/getPhone', {
    params,
    customFields: {
      // @ts-ignore
...
export function menberAdd(data: Record<string, any>) {
  return $http.post('/web/member/saveOrUpdate', data);
}
// 离职成员
export function menberResign(data: Record<string, any>) {
  return $http.post(`/web/member/resign?memberId=${data.memberId}`, data);
}

// 查找管理员信息
export function menberGetadmin(params: Record<string, any>) {
  return $http.get('/web/member/getAdmin', { params });
}
// 变更管理员- 查找企业下普通用户成员
export function menberNormal(params: Record<string, any>) {
  return $http.get('/web/member/getNormalMember', { params });
}
// 变更管理员
export function menberChangeAdmin(data: Record<string, any>) {
  return $http.post('/web/member/changeAdmin', data);
}
// 获取验证码
export function verificationCode(params: Record<string, any>) {
  return $http.get('/web/captcha/sendCaptcha', { params });
}
